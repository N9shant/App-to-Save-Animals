...
public class Create_Post extends AppCompatActivity{
    ...
    private EditText description, urge_level, select_ngo, post_type, animal_category, address;
    ...
    private DatabaseReference databaseReference = firebaseDatabase.getReference().child("All Posts").child(currentuid);
...
//        mAuth = FirebaseAuth.getInstance();
        ...
        create_post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                postMap.put("Urgency_level", Urgency_level);
                postMap.put("Select_NGO", Select_NGO);
                postMap.put("Post_Type", Post_Type);
                postMap.put("Animal_Category", Animal_Category);
                postMap.put("Address", Address);


                databaseReference.push().setValue(postMap);
                Toast.makeText(Create_Post.this, "Post Uploaded Successfully", Toast.LENGTH_LONG).show();
            }
        });
        ...
        categories1.add("Save Animals");
        categories1.add("Animal Aid Unlimited");
        categories1.add("People For Animals");
...
//        }
//
//        Post post = new Post(Description, Address);
//        databaseReference.push().setValue(post);
//
//        progressBar.setVisibility(View.GONE);
//
//        Toast.makeText(Create_Post.this, "Data Inserted", Toast.LENGTH_LONG).show();
//
//    }
}